...
> {
   ...
   */
  onChange?: RemirrorEventListener<Manager['~E']>;
...
interface BaseEventListenerParameter<ExtensionUnion extends AnyExtension>
...
export type RemirrorEventListenerParameter<
  ExtensionUnion extends AnyExtension
> = BaseEventListenerParameter<ExtensionUnion> &
  UnionToIntersection<ValueOf<Remirror.ListenerProperties<ExtensionUnion>>>;
