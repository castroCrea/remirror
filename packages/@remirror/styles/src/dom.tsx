 ...
 */
  ...
  .remirror-tooltip {
    background-color: var(--rmr-hue-gray-8);
    font-size: 0.8em;
    padding: 0.5rem;
    border-radius: 0.25rem;
    z-index: 999;
 ...
 */
  .remirror-theme {
    ...
    --rmr-color-active-background: #e6e6e6;
    --rmr-color-active-border: rgba(0, 0, 0, 0.25);
    --rmr-color-active-foreground: #000;
    --rmr-color-active-muted: #d3d9e0;
    --rmr-color-active-primary: #573bc7;
    --rmr-color-active-secondary: #abc73b;
    --rmr-color-active-primary-text: #fff;
    --rmr-color-active-secondary-text: #000;
    --rmr-color-active-text: #000;
    --rmr-color-hover-background: #ccc;
    --rmr-color-hover-border: rgba(0, 0, 0, 0.25);
    --rmr-color-hover-foreground: #000;
    --rmr-color-hover-muted: #b5c0cb;
    --rmr-color-hover-primary: #452ea1;
    --rmr-color-hover-secondary: #8aa12e;
